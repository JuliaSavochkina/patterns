...
Условия применимости:
    - требуется представить иерархию вида 'часть -- целое';
    - клиенты должны по единым правилам работать с составными и с индивидуальными объектами.

Позволяет:
    - определять иерархии классов, состоящих из примитивных и составных объектов;
    - упрощать архитектуру клиента;
    - облегчать добавление новых видов компонентов;
    - способствовать созданию общего дизайна.
"""
